...
class _Scheduler__1__(_RBObject):
    def __init__(self):
        # init tracing
        self._layout = 0
...
class _DeviceTaskDataRecord__1__(_RBObject):
    def __init__(self):
        self.pending = _NO_WORK


class _HandlerTaskDataRecord__1__(_RBObject):
    def __init__(self):
...
class _IdleTaskDataRecord__1__(_RBObject):
    def __init__(self):
        self.control = 1
        self.count = 10_000


class _Packet__1__(_RBObject):
...
class _WorkerTaskDataRecord__1__(_RBObject):
    def __init__(self):
